    ...
    try {
      ...
      for (const educationEntry of educationInfo) {
        ...
        if (querySnapshot.empty) {
          ...
          console.log(
            `Similar education entry for ${institution} - ${degree} already exists within a year of the provided graduation date.`
          );
        ...
        {educationInfos.length > 0 ? (
          educationInfos.map((experience, index) => (
            <div>
              ...
              <p>
                {experience.startDate instanceof Timestamp
                  ? experience.startDate.toDate().toISOString()
              ...
              <p>
                {experience.endDate instanceof Timestamp
                  ? experience.endDate.toDate().toISOString()
                  : experience.endDate || "Current School"}
              </p>
              <hr></hr>
            </div>
          ))
  ...
  return (
    ...
    >
      ...
      <input
        ...
        name="startDate"
        value={
          education.startDate instanceof Timestamp
            ? education.startDate.toDate().toISOString()
            : education.startDate || ""
        }
      ...
      <input
        ...
        name="endDate"
        value={
          education.endDate instanceof Timestamp
            ? education.endDate.toDate().toISOString()
            : education.endDate || ""
        }
